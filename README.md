...
```bash
git clone https://github.com/PulsePhoenixFlow/antenna-forge-454.git
cd antenna-forge-454
python setup.py
```
...
# Clone the project
git clone https://github.com/PulsePhoenixFlow/antenna-forge-454 yaf && cd yaf
...
<!-- Last updated: 2026-06-06 17:29:36 -->
